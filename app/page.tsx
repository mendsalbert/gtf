          ...
          <div className="flex items-center justify-between h-16 lg:h-[72px] gap-4">
            ...
            <Link href="/" className="flex items-center gap-3 flex-shrink-0 min-w-0 group">
              <Image
                ...
                width={48}
                height={48}
                className="object-contain w-11 h-11 lg:w-12 lg:h-12 flex-shrink-0"
              />
              <div className="min-w-0 leading-tight">
                {/* Mobile — stacked on two lines */}
                <div className="sm:hidden">
                  <span className="font-display block text-[13px] font-bold text-white tracking-tight">
                    Growing Together
                  </span>
                  <span className="font-display block text-[13px] font-bold text-[#f56d24] tracking-tight">
                    Family
                  </span>
                </div>
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="font-body text-[10px] text-gray-500 tracking-wide mt-0.5">
                    GTF Church · Ghana
                  </p>
                </div>
              </div>
            ...
            <nav className="hidden lg:flex items-center gap-6 flex-1 justify-center">
              {NAV_LINKS.map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
                  className="font-body text-gray-400 hover:text-white text-xs font-medium tracking-wide transition-colors duration-200 whitespace-nowrap"
                >
                  {link.label}
                </Link>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-8 items-stretch py-10">
            ...
            <div className="flex flex-col justify-center py-4">
              <h1 className="font-display font-extrabold text-[2rem] sm:text-[2.75rem] lg:text-[3.25rem] leading-[1.08] tracking-tight text-gray-900 mb-5">
                A church family that grows together in{" "}
                <span className={`text-[#f56d24] inline-block transition-all duration-300 ${isAnimating ? "opacity-0 -translate-y-2 blur-sm" : "opacity-100 translate-y-0 blur-none"}`}>
                  {WORDS[currentWord].toLowerCase()}
                </span>
              </h1>

              <p className="font-body text-base sm:text-lg text-gray-800 mb-2 leading-snug">
                <span className="font-display font-bold uppercase tracking-wide">Free resources</span>{" "}
                for kids, youth, adults &amp; families
              </p>
